...
<div class="navbar navbar-fixed-top custom-navbar" role="navigation">
     <div class="container">
          <div class="navbar-header">
               ...
               <a href="#" class="navbar-brand">Zainullah</a>
          </div>
               ...
               <div class="col-md-6 col-sm-6">
                    <div class="home-thumb">
                         <div class="section-title">
                              ...
                              <h1 class="wow fadeInUp" data-wow-delay="0.6s">Hello guys, My Name is<strong> Zainullah </strong> i come from Pamekasan...</h1>
                              <p class="wow fadeInUp" data-wow-delay="0.9s">I am a student at Madura university.</p>                            
                         </div>
                    </div>
               </div>
          </div>
               ...
               <div class="col-md-6 col-sm-12">
                    <div class="contact-form">
                         <div class="wow fadeInUp section-title" data-wow-delay="0.2s">
                              ...
                              <p class="color-white">Enter your message here. . .</p>
                         </div>
                         <div id="contact-form">
                              <form action="#template-mo" method="">
               ...
               <div class="bg-dark col-md-3 col-sm-6">
                    <div class="contact-thumb">
                         ...
                         <div class="wow fadeInUp contact-info" data-wow-delay="0.8s">
                              ...
                              <p><i class="fa fa-phone"></i> +62 878-8294-7247</p>
                              <p><i class="fa fa-envelope-o"></i> <a href="mailto:hello@company.co">zainpelope807@gmail.com</a></p>
                              <p><i class="fa fa-youtube"></i> <a href="#">zain pelope</a></p>
                         </div>
                    </div>
               </div>
          </div>
		...
		<div class="row">
               <div class="col-md-12 col-sm-12">
				...
				<ul class="wow fadeInUp social-icon" data-wow-delay="2s">
                         ...
                         <li><a href="https://www.youtube.com/channel/UCinSAdeiYvsYBsEZWEPWmkQ" class="fa fa-youtube"></a></li>
